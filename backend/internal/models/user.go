...
type User struct {
	...
	AvatarType               string     `gorm:"size:20;default:image" json:"avatar_type,omitempty"`
	BannerURL                string     `gorm:"size:1024" json:"banner_url,omitempty"`
	BannerType               string     `gorm:"size:20;default:image" json:"banner_type,omitempty"`
	AvatarDecorationPreset   string     `gorm:"size:64" json:"avatar_decoration_preset,omitempty"`
	AvatarDecorationURL      string     `gorm:"size:1024" json:"avatar_decoration_url,omitempty"`
	ProfileCustomizationJSON string     `gorm:"type:text" json:"profile_customization_json,omitempty"`
...
type UserResponse struct {
	...
	AvatarDecorationPreset   string    `json:"avatar_decoration_preset,omitempty"`
	AvatarDecorationURL      string    `json:"avatar_decoration_url,omitempty"`
	ProfileCustomizationJSON string    `json:"profile_customization_json,omitempty"`
